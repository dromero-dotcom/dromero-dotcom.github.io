...
The initial dataset contained 951,669 records, with 20 columns (features). It was necessary to pre-process it (aggregate data) for a
meaningful analysis. There were 5 features considered relevant for creating meaningful clusters:
...
Boxplots of the processed dataset reveal outliers in 4 of the 5 features (not with customer age).
...
Based on these overlapping numbers, the "optimal" number chosen was k=5 clusters (based on the highest average value of the Silhoutte score).
...
<img src="images/proj2/Clusters_Table.png?raw=true"/>
